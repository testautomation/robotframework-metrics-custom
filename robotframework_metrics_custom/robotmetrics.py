...
from .test_results_failed import TestResultsFailed
...
def generate_report(opts):
    ...
    <div class="sidenav">
        ...
        <a class="tablink" href="#" onclick="openPage('testMetrics', this, 'orange'); executeDataTable('#tm',3)"><i class="fa fa-list-alt"></i> Passed Test Metrics</a>
        <a class="tablink" href="#" onclick="openPage('testMetrics_failed', this, 'orange'); executeDataTable('#tmf',3)"><i class="fa fa-list-alt"></i> Failed Test Metrics</a>        
    ...
    <div class="tabcontent" id="dashboard">
                    ...
                    <div class="row">
                        ...
                        title="Click to view Passed Test metrics" style="cursor: pointer;">
                            <a class="tile tile-pass">
                                %s
                                <p style="font-size:12px">Pass</p>
                            </a>
                        </div>						
                        <div class="col-md-3"  onclick="openPage('testMetrics_failed', this, '')" data-toggle="tooltip"
                        title="Click to view Failed Test metrics" style="cursor: pointer;">
                            <a class="tile tile-fail">
                                %s
                                <p style="font-size:12px">Fail</p>
                            </a>
                    ...
                    <hr></hr>
                    <div class="row">
                        <div class="col-md-6" style="background-color:white;height:300px;width:auto;border:groove;">
    ...
    """ % (elapsedtime, generator, total_suite, passed_suite, failed_suite, total, passed, failed,
           passed_suite, failed_suite, passed, failed)
    ...
    logging.info("3 of 4: Capturing passed test metrics...")
    ...
    ### ============================ END OF TEST METRICS ============================================ ####
    logging.info("4 of 4: Capturing failed test metrics...")
    ### ============================ START OF FAILED TEST METRICS ======================================= ####

    # Tests div
    tmf_div = soup.new_tag('div')
    tmf_div["id"] = "testMetrics_failed"
    tmf_div["class"] = "tabcontent"
    page_content_div.insert(100, tmf_div)

    test_icon_txt = """
    <h4><b><i class="fa fa-table"></i> Failed Test Metrics</b></h4>
    <hr></hr>
    """
    tmf_div.append(BeautifulSoup(test_icon_txt, 'html.parser'))

    # Create table tag
    table = soup.new_tag('table')
    table["id"] = "tmf"
    table["class"] = "table table-striped table-bordered"
    tmf_div.insert(10, table)
    ...
    # GET TEST METRICS
    if group:
        group.spawn(result.visit, TestResultsFailed(soup, test_tbody, log_name))
    else:
        result.visit(TestResultsFailed(soup, test_tbody, log_name))
...
<body>
    ...
    <table>
        <tbody>
            <tr>
                <td style="width:50%;color:#0b6690;"><h3>Suite Status</h3></td>
                <td style="width:50%;color:#0b6690;"><h3>Test Status</h3></td>
